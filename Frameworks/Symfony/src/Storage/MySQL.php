...
class MySQL
{
    ...
    {
        $connection = new mysqli('mysql_arquitectura_avanzada', 'root', 'root', 'test');
    ...
    public static function findBy(string $table, array $find): array
    {
        try {
            $wher = ' WHERE ';
            $i = 0;
    ...
    public static function findOneBy(string $table, array $find): array
    {
        try {
            $wher = ' WHERE ';
            $i = 0;
    ...
    public static function findById(string $table, int $findId): array
    {
        try {
    ...
    public static function insert(string $table, array $insert): bool
    {
        try {
            $data_key = '';
            $data_value = '';
    ...
    public static function deleteById(string $table, int $idToDelete): bool
    {
        try {
